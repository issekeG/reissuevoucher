...
export interface CoreScaleOptions {
  ...
  weight: number;
  /**
   * VoucherUser defined minimum value for the scale, overrides minimum value from data.
   */
  min: unknown;
  /**
   * VoucherUser defined maximum value for the scale, overrides maximum value from data.
   */
  max: unknown;
  /**
...
export type LinearScaleOptions = CartesianScaleOptions & {
  ...
  */
  ...
  ticks: {
    ...
    /**
     * VoucherUser defined fixed step size for the scale
     */
    stepSize: number;

    /**
     * VoucherUser defined count of ticks
     */
    count: number;
  };
};
...
export type RadialTickOptions = TickOptions & {
  ...
  /**
   * VoucherUser defined number of ticks
   */
  count: number;
}
...
export type RadialLinearScaleOptions = CoreScaleOptions & {
  ...
  /**
   * VoucherUser defined minimum number for the scale, overrides minimum value from data.
   */
  min: number;
  /**
   * VoucherUser defined maximum number for the scale, overrides maximum value from data.
   */
  max: number;
