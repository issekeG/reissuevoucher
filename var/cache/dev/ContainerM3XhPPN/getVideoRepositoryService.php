...
{
    /**
     * Gets the private 'App\Repository\trainingvideos\VideoRepository' shared autowired service.
     *
     * @return \App\Repository\trainingvideos\VideoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'trainingvideos'.\DIRECTORY_SEPARATOR.'VideoRepository.php';

        return $container->privates['App\\Repository\\trainingvideos\\VideoRepository'] = new \App\Repository\trainingvideos\VideoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
