...
{
    /**
     * Gets the private 'App\Repository\trainingvideos\CategoryRepository' shared autowired service.
     *
     * @return \App\Repository\trainingvideos\CategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'trainingvideos'.\DIRECTORY_SEPARATOR.'CategoryRepository.php';

        return $container->privates['App\\Repository\\trainingvideos\\CategoryRepository'] = new \App\Repository\trainingvideos\CategoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
