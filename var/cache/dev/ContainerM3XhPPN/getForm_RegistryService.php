...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\reissuevoucher\\RegistrationFormType' => ['privates', 'App\\Form\\reissuevoucher\\RegistrationFormType', 'getRegistrationFormTypeService', true],
            'App\\Form\\reissuevoucher\\Voucher_reissueType' => ['privates', 'App\\Form\\reissuevoucher\\Voucher_reissueType', 'getVoucherTypeService', true],
            'App\\Form\\reissuevoucher\\Voucher_reissueTypeEdit' => ['privates', 'App\\Form\\reissuevoucher\\Voucher_reissueTypeEdit', 'getVoucherTypeEditService', true],
            'App\\Form\\trainingvideos\\CategoryType' => ['privates', 'App\\Form\\trainingvideos\\CategoryType', 'getCategoryTypeService', true],
            'App\\Form\\trainingvideos\\VideoType' => ['privates', 'App\\Form\\trainingvideos\\VideoType', 'getVideoTypeService', true],
            ...
            'App\\Form\\reissuevoucher\\RegistrationFormType' => '?',
            'App\\Form\\reissuevoucher\\Voucher_reissueType' => '?',
            'App\\Form\\reissuevoucher\\Voucher_reissueTypeEdit' => '?',
            'App\\Form\\trainingvideos\\CategoryType' => '?',
            'App\\Form\\trainingvideos\\VideoType' => '?',
