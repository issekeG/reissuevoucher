 ...
 */
class getVoucherRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\reissuevoucher\VoucherRepository' shared autowired service.
     *
     * @return \App\Repository\reissuevoucher\VoucherRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'reissuevoucher'.\DIRECTORY_SEPARATOR.'VoucherRepository.php';

        return $container->privates['App\\Repository\\reissuevoucher\\VoucherRepository'] = new \App\Repository\reissuevoucher\VoucherRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
