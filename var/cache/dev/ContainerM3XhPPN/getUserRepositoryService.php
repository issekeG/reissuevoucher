...
{
    /**
     * Gets the private 'App\Repository\reissuevoucher\UserRepository' shared autowired service.
     *
     * @return \App\Repository\reissuevoucher\UserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'reissuevoucher'.\DIRECTORY_SEPARATOR.'UserRepository.php';

        return $container->privates['App\\Repository\\reissuevoucher\\UserRepository'] = new \App\Repository\reissuevoucher\UserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
