...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\reissuevoucher\\UserRepository' => ['privates', 'App\\Repository\\reissuevoucher\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\reissuevoucher\\VoucherRepository' => ['privates', 'App\\Repository\\reissuevoucher\\VoucherRepository', 'getVoucherRepositoryService', true],
            'App\\Repository\\trainingvideos\\CategoryRepository' => ['privates', 'App\\Repository\\trainingvideos\\CategoryRepository', 'getCategoryRepositoryService', true],
            'App\\Repository\\trainingvideos\\VideoRepository' => ['privates', 'App\\Repository\\trainingvideos\\VideoRepository', 'getVideoRepositoryService', true],
        ], [
            'App\\Repository\\reissuevoucher\\UserRepository' => '?',
            'App\\Repository\\reissuevoucher\\VoucherRepository' => '?',
            'App\\Repository\\trainingvideos\\CategoryRepository' => '?',
            'App\\Repository\\trainingvideos\\VideoRepository' => '?',
        ])));
