...
return [
    ...
    [ // $staticRoutes
        ...
        '/reissuevoucher/voucher' => [[['_route' => 'app_voucher_index', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::index'], null, ['GET' => 0], null, false, false, null]],
        '/reissuevoucher/voucher/form' => [[['_route' => 'app_voucher_new', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::new'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/reissuevoucher/voucher/search' => [[['_route' => 'app_voucher_search', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::search'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        80 => [[['_route' => 'app_voucher_show', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        92 => [[['_route' => 'app_voucher_edit', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        99 => [[['_route' => 'app_voucher_delete', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::delete'], ['id'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        134 => [[['_route' => 'voucher_update_status', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::updateStatus'], ['status', 'id'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        142 => [[['_route' => 'voucher_dashboard_status', '_controller' => 'App\\Controller\\reissuevoucher\\VoucherController::showShoesByStatus'], ['status'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
