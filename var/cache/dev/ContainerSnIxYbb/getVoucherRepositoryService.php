...
{
    /**
     * Gets the private 'App\Repository\VoucherRepository' shared autowired service.
     *
     * @return \App\Repository\VoucherRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VoucherRepository.php';

        return $container->privates['App\\Repository\\VoucherRepository'] = new \App\Repository\VoucherRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
