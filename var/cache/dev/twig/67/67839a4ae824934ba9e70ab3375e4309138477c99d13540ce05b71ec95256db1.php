...
/* reissuevoucher/voucher/show.html.twig */
class __TwigTemplate_10744b5ad8cea30ffe69fdfbc01fb7e77d5304955e50c27bfeb53dcc28904042 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "reissuevoucher/voucher/show.html.twig"));

        $this->parent = $this->loadTemplate("reissuevoucher/base.html.twig", "reissuevoucher/voucher/show.html.twig", 1);
    ...
    <a href=\"";
        // line 99
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_voucher_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["reissue_request"]) || array_key_exists("reissue_request", $context) ? $context["reissue_request"] : (function () { throw new RuntimeError('Variable "reissue_request" does not exist.', 99, $this->source); })()), "id", [], "any", false, false, false, 99)]), "html", null, true);
        echo "\">edit</a>
...
";
    ...
    {
        return "reissuevoucher/voucher/show.html.twig";
    }
...
{% block body %}
    ...
    <a href=\"{{ path('app_voucher_index') }}\">back to list</a>

    <a href=\"{{ path('app_voucher_edit', {'id': reissue_request.id}) }}\">edit</a>

    {{ include('reissuevoucher/voucher/_delete_form.html.twig') }}
{% endblock %}
", "reissuevoucher/voucher/show.html.twig", "C:\\Users\\gicke\\PhpstormProjects\\reissuevoucher\\templates\\reissuevoucher\\voucher\\show.html.twig");
    }
}
