...
class VoucherTypeEdit extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('authorizedBy', TextType::class, ['label' => 'Authorized By : ','attr' => ['class' => 'form-control'],])
            ->add('authorizedSignature', TextType::class, ['label' => 'Authorized Signature : ','attr' => ['class' => 'form-control'],])
            ->add('authorizedDate', DateType::class, ['label' => 'Authorized Date : ','attr' => ['class' => 'form-control'],])
