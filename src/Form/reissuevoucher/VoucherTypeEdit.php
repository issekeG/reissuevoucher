...
class VoucherTypeEdit extends AbstractType
{
    private $security;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('dateOfPurchase', DateType::class, ['label' => 'Date of Purchase : ','attr' => ['class' => 'form-control', 'disabled' => true],])
            ...
            ->add('requestedDate', DateType::class, ['label' => 'Requested Date : ','attr' => ['class' => 'form-control', 'readonly' => true],])
            ...
            ->add('authorizedDate', DateType::class, ['label' => 'Authorized Date : ','attr' => ['class' => 'form-control', 'readonly' => true],])
            ->add('newEvoucherReference', TextType::class, ['label' => 'New eVoucher Reference : ','attr' => ['class' => 'form-control', 'readonly' => true],])
            ->add('newEvoucherDate', DateType::class, ['label' => 'New eVoucher Date : ','attr' => ['class' => 'form-control', 'readonly' => true],])
            ->add('cardLinkedTo', TextType::class, ['label' => 'Card Linked To : ','attr' => ['class' => 'form-control', 'readonly' => true],])
            ->add('deliveredTo', TextType::class, ['label' => 'Delivered To : ','attr' => ['class' => 'form-control', 'readonly' => true],])
        ...
        ;
            ...
            $builder->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) {
                ...
                $isUserAuthenticated = $this->security->isGranted('APPOUVED');

                // Dynamically add a field based on some condition
